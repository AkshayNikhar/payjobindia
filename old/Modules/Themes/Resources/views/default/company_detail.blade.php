...
<div class="employer-header bg-light" style="
        ...
        <div class="clearfix">
            ...
            <div class="employer-info-detail">
                ...
                <div class="employer-metas">
                    ...
                    @endisset
                    @isset($company->phone)
                    <div class="employer-deadline"><i class="pe-7s-headphones"></i> {{$company->phone[3]}} *******</div>
                    @endisset
                    @isset($company->company_email)
                    <div class="employer-salary"><i class="pe-7s-mail"></i> {{$company->company_email[3]}} *******</div>
                    @endisset
                </div>
                    ...
                    <div class="job-phone">
                        ...
                        <div class="value">
                            <div class="phone-wrapper phone-hide">
                                <a class="phone" href="tel:{{$company->phone}}">{{$company->phone[3]}} *********</a>
                            </div>
                        </div>
                    </div>
                    @endisset
