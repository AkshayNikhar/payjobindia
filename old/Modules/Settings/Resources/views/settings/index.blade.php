            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                <div class="form-label">@lang('Banner Image')</div>
                                <div class="custom-file">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <input name="FACEBOOK_URL" placeholder="Facebook Url" class="form-control" value="{{ config('app.FACEBOOK_URL') }}">
                                <small class="help-block">Input your facebook handle url</small>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input name="INSTAGRAM_URL" placeholder="Instagram Url" class="form-control" value="{{ config('app.INSTAGRAM_URL') }}">
                            <small class="help-block">Input your instagram handle url</small>
                        </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input name="TWITTER_URL" placeholder="Twitter Url" class="form-control" value="{{ config('app.TWITTER_URL') }}">
                                <small class="help-block">Input your twitter handle url</small>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="form-label">Contact Mail</label>
                                <input name="CONTACT_MAIL" placeholder="Contact mail" class="form-control" value="{{ config('app.CONTACT_MAIL') }}">
                                <small class="help-block">Input your contact email</small>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input name="CONTACT_ADDRESS" placeholder="Contact Address" class="form-control" value="{{ config('app.CONTACT_ADDRESS') }}">
                                <small class="help-block">Input your contact address</small>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input name="CONTACT_NUMBER" placeholder="Contact Number" class="form-control" value="{{ config('app.CONTACT_NUMBER') }}">
                                <small class="help-block">Input your contact number</small>
                            </div>
                        </div>
                    </div>
