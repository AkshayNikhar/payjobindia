...
Route::middleware('auth')->group(function () {
	...
	Route::middleware('can:employer')->group(function () {
		...
		Route::group(['prefix' => 'company', 'as' => 'company.'], function(){
			...
			Route::get('applicants/view-users', 'EmployerApplicantsController@viewAppliedUsers')->name('view-job-applied-user');
	...
	Route::middleware('can:admin')->prefix('settings')->name('settings.')->group(function () {
		...
		Route::get('companies-export', 'CompaniesController@companiesExport')->name('companiesExport');
	
		// companies
		Route::resource('companies', 'CompaniesController')->except('show');

		Route::resource('jobs', 'JobsController')->except('show');
		Route::get('admin-exports/jobs/export', 'JobsController@exportToCsv')->name('adminExportJobs');
	});
});
