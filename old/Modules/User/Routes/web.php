...
Route::middleware(['auth'])->group(function () {
    ...
    Route::middleware('can:admin')->prefix('settings')->name('settings.')->group(function () {
        ...
        Route::get('/block', 'UserController@block')->name('users.block');
        Route::get('/un-block', 'UserController@unblock')->name('users.unblock');
        
        Route::get('admin-exports/users/export', 'UserController@exportToCsv')->name('userExport');
