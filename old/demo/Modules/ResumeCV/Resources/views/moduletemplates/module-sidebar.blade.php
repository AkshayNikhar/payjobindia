...
<li class="nav-item {{ (request()->is('resumecv*')) ? 'active' : '' }}">
	<a class="nav-link" href="{{ route('resumecv.index') }}">
		...
		<span>@lang('Total ResumeCV')</span></a>
</li>

<li class="nav-item {{ (request()->is('myappliedjobs')) ? 'active' : '' }}">
	<a class="nav-link" href="{{ route('myappliedjobs') }}">
		<i class="far fa-file-alt"></i>
		<span>Total Applied Jobs</span></a>
</li>

<li class="nav-item {{ (request()->is('alltemplates*')) ? 'active' : '' }}">
	<a class="nav-link" href="{{ url('alltemplates')}}">
		<i class="far fa-window-maximize"></i>
		<span>@lang('Create Resume')</span></a>
</li>
@endcan
@can('admin')
@can('View Applied Jobs')
<li class="nav-item {{ (request()->is('appliedjobs')) ? 'active' : '' }}">
	<a class="nav-link" href="{{ route('settings.appliedjobs') }}">
		<i class="far fa-file-alt"></i>
