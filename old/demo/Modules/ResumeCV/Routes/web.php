...
Route::middleware('auth')->group(function () {
	...
	Route::middleware('can:candidate')->group(function () {
		...
		Route::get('myappliedjobs', 'ResumeCVController@myappliedjobs')->name('myappliedjobs');
	...
	Route::middleware('can:admin')->prefix('settings')->name('settings.')->group(function () {
        ...
        Route::get('appliedjobs', 'ResumeCVController@appliedjobs')->name('appliedjobs');
        Route::get('appliedjobs/view-users', 'ResumeCVController@viewAppliedUsers')->name('view-job-applied');
        
        Route::get('appliedJobsExport', 'ResumeCVController@appliedJobsExport')->name('appliedJobsExport');
