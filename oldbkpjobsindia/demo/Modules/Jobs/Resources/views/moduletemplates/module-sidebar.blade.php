...
<li class="nav-item">
	...
	<div id="collapseJobs" class="collapse {{ (request()->is('settings/jobs*')) ? 'show' : '' }}" aria-labelledby="headingTwo" data-parent="#accordionSidebar" style="">
		<div class="bg-white py-2 collapse-inner rounded">
...
<li class="nav-item">
	...
	<div id="collapseJobAttributes" class="collapse {{ (request()->is('settings/job-attributes*')) ? 'show' : '' }}" aria-labelledby="headingTwo" data-parent="#accordionSidebar" style="">
		<div class="bg-white py-2 collapse-inner rounded">
			...
			<a class="collapse-item {{ routeName() == 'settings.job.attributes.degree_types.index' ? 'active' : '' }}" href="{{ route('settings.job.attributes.degree_types.index') }}">
...
@can('employer')
	...
	@endcan
	@if(Modules\Jobs\Entities\Company::where('user_id', \Auth::user()->id)->value('company_name') != '')
	@can('Post Company Jobs')
