...
<div class="row">
    <div class="col-md-4">
        <a href="{{route('company.jobs.index')}}" class="text-decoration-none">
            <div class="card shadow h-100" style="background: #eb4189;">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-white">{{ $total_jobs ?? 0}}</div>
                        </div>
                        <div class="col-auto">
    ...
    <div class="col-md-4">
        <a href="{{url('/company/applicants')}}" class="text-decoration-none">
            <div class="card shadow h-100">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="font-weight-bold text-gray-600 text-uppercase mb-1">
                                @lang('Total Applicants')
                            </div>
                            <div class="h5 mb-0 font-weight-bold text-gray-600">{{ $applicants ?? 0 }}</div>
                        </div>
                        <div class="col-auto">
    ...
    <div class="col-md-4">
        <a href="{{route('company.jobs.index')}}" class="text-decoration-none">
            <div class="card shadow h-100" style="background: #01abeb;">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="font-weight-bold text-white text-uppercase mb-1">@lang('Total Urgent Jobs')
                            </div>
                            <div class="row no-gutters align-items-center">
                                <div class="col-auto">
                                    <div class="h5 mb-0 mr-3 font-weight-bold text-white">{{$total_jobs_featured}}</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-auto">
...
<div class="row">
    <div class="col-md-12 p-3">
        <canvas id="applicantsChart" width="500" height="200"></canvas>
    </div>
</div>
@if(Module::find('Saas'))
<div class="mt-4 mb-4">
...
<script>
  ...
  const data = {
    labels: labels,
    datasets: [{
      label: 'Total Applicants According To Month',
      backgroundColor: 'rgb(255, 99, 132)',
      borderColor: 'rgb(255, 99, 132)',
      data: [{{$applicantsJan}}, {{$applicantsFeb}}, {{$applicantsMarch}}, {{$applicantsApril}}, {{$applicantsMay}}, {{$applicantsJune}}, {{$applicantsJuly}}, {{$applicantsAugust}}, {{$applicantsSeptember}}, {{$applicantsOctober}}, {{$applicantsNovember}}, {{$applicantsDecember}}],
    }]
  };
