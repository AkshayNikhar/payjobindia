  ...
  <article>
      <div class="item-job-list">
          <div class="item-job-half">
              <div class="item-flex-box">
                  <div class="item-job-img">
                      <a href=""><img src="https://demo.payjobindia.com/storage/user_storage/97/company_logo_14970506.png" class="img-responsive" alt="prashant Academy Pvt" style="width:80px;"></a>
                  </div>

                    <div class="item-job-pos">
                      <h3 class="jb-title align-items-center m-1"><a href="https://demo.payjobindia.com/login" style="color:#1555d6">Graphic Designer (Graphic Design - BArch)</a></h3>
                      
                     <div class="job-metas">
                          <!--<div class="job-location job-features-tabs m-1" style="font-size: 14px;">-->
                            <div class="job-location m-1 mr-4" style="font-size: 14px;">
                              <i class="pe-7s-map-marker"></i>
                              <a href="https://demo.payjobindia.com/jobs?city=1">Location : Nagpur</a>
                            </div>
                          ...
                          <!--<div class="category-job job-features-tabs m-1">-->
                            ...
                            <div class="category-job m-1 mr-4">
                                <div class="job-category with-icon" style="font-size: 14px;">
                                  <i class="pe-7s-shopbag"></i><a href="#" style=""> Experience : 1 Year</a>
                                </div>
                            </div>
                            ...
                            <div class="category-job m-1 mr-4">
                              <div class="job-category with-icon" style="font-size: 14px;">
                                  <i class="pe-7s-copy-file"></i>
                                  <a href="#" style=""> Work Mode : onsite</a>
                              </div>
                            </div>
                            ...
                            <div class="category-job m-1 mr-4">
                              <div class="job-category with-icon" style="font-size: 14px;">
                                  <i class="pe-7s-id"></i>
                                  <a href="https://demo.payjobindia.com/jobs?functionalarea=40" style=""> Education : Graduation</a>
                              </div>
                            </div>
                            <div class="job-deadline m-1 mr-4" style="font-size: 14px;"><i class="pe-7s-date"></i> Post Date : Nov 21, 2023</div>
                                                            <div class="job-salary m-1" style="font-size: 14px;"><i class="pe-7s-rupees"></i> <span class="price-text">Salary : 10000 <span class="suffix">INR</span> - <span class="price-text">15000 <span class="suffix">INR</span></span>
                              </span></div>
                                                    </div>
                  </div>
