...
<section class="pt-4 p-5" style="background:url({{url('/modules/themes/default/images/banner-small.jpeg')}});">
                ...
                <div class="row mt-3">
                    <div class="col-md-12">
                        ...
                        <form id="form_search" action="javascript:void(0);">
                            ...
                            <div id="form-search-advanced" class="mt-2 d-none">
                                <div class="row">
                            ...
                            <div class="row d-none">
                                ...
                                <div class="col-md-3">
                                    <div class="pull-right" id="show_advanced">
                                        <a href="#" id="btn-show-advanced-search" class="text-white">
                                            <i class="pe-7s-angle-down"></i>@lang('Search advanced')
                                        </a>
                                        <a href="#" id="btn-hidden-advanced-search" class="text-white">
