...
class EmployerJobsController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        return view('jobs::employer_jobs.create', compact('countries','states','cities','degreeTypes', 'careerLevels', 'salaryPeriods', 'functionalAreas', 'genders', 'jobTypes', 'jobShifts', 'degreeLevels', 'jobExperiences'));
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return view('jobs::employer_jobs.edit', compact('job', 'countries','states','cities','degreeTypes', 'careerLevels', 'salaryPeriods', 'functionalAreas', 'genders', 'jobTypes', 'jobShifts', 'degreeLevels', 'jobExperiences'));
    }
