				...
				<tbody>
					...
					<tr>
						<td data-label="Job Title">
							<div class="company-info">
								...
								<div class="company-details">
									<div class="top">
										<h6><a href="<?php echo base_url('job1/'.$joblist->slug) ?>"> <?= esc($joblist->title) ?></a></h6> </div>
									<ul>
						...
						<td data-label="Status">
							...
							<?php
							if($job->active_status=='Shortlist'){
							    $ststus='text-success';
							}
							else if($job->active_status=='Selected'){
							    $ststus='text-info';
							}
							else if($job->active_status=='Rejected'){
							    $ststus='text-danger';
							}
							else if($job->active_status=='Hold'){
							    $ststus='text-warning';
							}else{
							    $ststus='text-dark';
							}
							?>
							<button class="status <?php echo $ststus ?>"><?= esc($job->active_status) ?></button>
						</td>
					</tr>
					<?php } ?>
