...
<head>
    <title>Today Companies | Pay Job India</title>
                ...
                <div class="row ">
                    <div class="col-8">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18">Today Companies</h4>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                if($d->vendorID==0){
                                                ?>
                                                <span style="font-size: 15px;font-weight: 600;">Employer</span>
                                                <?php } else{ ?>
                                                <a href="total-vendor-company-jobs/<?= esc($vendorid) ?>" style="color: #f00;font-size: 15px;font-weight: 600;">Member</a>
                                                <?php } ?>
                                            </td>
