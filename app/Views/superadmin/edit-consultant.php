...
<head>
    <title>Edit Consultant | Pay Job India</title>
                ...
                <div class="row">
                    <div class="col-8">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18">Edit Consultant </h4>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form method="POST" class="needs-validation" enctype="multipart/form-data" action="<?= base_url('superadmin/edit-consultant'); ?>"  novalidate>
                                                ...
                                                <div class="col-lg-2 mt-2">
                                                    <div class="form-check mb-3">
                                                        <input class="form-check-input" name="permissions[]" type="checkbox" value="<?php echo $id ?>"
                                                            <?php echo (in_array($id, array_column($permission_emp1, 'permission_type_id'))) ? 'checked' : ''; ?>>
