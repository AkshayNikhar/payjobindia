...
<head>
    <title>Consultant | Pay Job India</title>
                ...
                <div class="row ">
                    <div class="col-8">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18">All Consultant</h4>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                               ...
                                               <?php 
                                                ...
                                                ?>
                                               <a href="edit-consultant/<?= esc($id) ?>" class="btn btn-sm btn-primary w-20"><i class="bx bx-pencil"></i></a>
