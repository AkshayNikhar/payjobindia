                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group mb-3">
											    ...
											    if(!empty($functionareas))
											    {
    											    ...
    											    {
    											        if($c->id == $datajobpost->functional_area_id)
                                                        {
                                                            $sel1='selected';
                                                        }
                                                        else
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group mb-3">
                                                ...
                                                <select name="career_level_id" id="career_level_id" class="form-control select2">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group mb-3">
                                                ...
                                                <select name="degree_level_id" id="degree_level_id" class="form-control select2">
                                                <option selected hidden>Select ...</option>
                                                <?php
                                                    foreach($degree as $s)
												    {
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group mb-3">
                                                ...
                                                <select name="degree_type_id" id="degree_type_id" class="form-control select2">
                                                <option selected hidden>Select ...</option>
                                                <?php
                                    ...
                                    <div class="row " style="margin-top: 20px;">    
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group mb-3">
                                                ...
                                                <select name="job_experience_id" id="job_experience_id" class="form-control select2">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group mb-3">
                                                ...
                                                <select name="vacancy_type" id="vacancy_type" class="form-select">
                                                    ...
                                                    <!--<option value='Intership' <!?php if($datajobpost->work_mode=='Intership') {echo 'selected';} ?>>Intership</option>-->
                                                    <!--<option value='Jobs' <!?php if($datajobpost->work_mode=='Jobs') {echo 'selected';} ?>>Jobs</option>-->
                                                    <?php
                                                        foreach($vtype as $s)
    												    {
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text" name="contact_person_name" value="<?php echo $datajobpost->contact_person_name; ?>" class="form-control border-dark" >
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            <div class="form-group mb-3">
                                                <label class="form-label required">Contact Person Number</label>
                                                <input type="text" name="contact_person_number" value="<?php echo $datajobpost->contact_person_number; ?>" class="form-control border-dark" >
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            <div class="form-group mb-3">
                                                <label class="form-label required">Contact Person Designation</label>
                                                <input type="text" name="contact_person_designation" value="<?php echo $datajobpost->contact_person_designation; ?>" class="form-control border-dark" >
                                            </div>
                                        </div>
                                        </div>
                                        <div class="row mt-2">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group mb-3">
                                                <label class="form-label required">Is Display Description</label>
                                                <select name="isdisplay_des" class="form-select" required="">
                                                    <option value="1" <?php if($datajobpost->isdisplay_des==1) {echo 'selected';} ?>>Yes</option>
                                                    <option value="0" <?php if($datajobpost->isdisplay_des==0) {echo 'selected';} ?>>No</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            <div class="form-group mb-3">
                                                <label class="form-label required">Is Display Responsibility</label>
                                                <select name="isdisplay_res" class="form-select" required="">
                                                    <option value="1" <?php if($datajobpost->isdisplay_res==1) {echo 'selected';} ?>>Yes</option>
                                                    <option value="0" <?php if($datajobpost->isdisplay_res==0) {echo 'selected';} ?>>No</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            <div class="form-group mb-3">
                                                <label class="form-label required">Is Display Requirement</label>
                                                <select name="isdisplay_req" class="form-select" required="">
                                                    <option value="1" <?php if($datajobpost->isdisplay_req==1) {echo 'selected';} ?>>Yes</option>
                                                    <option value="0" <?php if($datajobpost->isdisplay_req==0) {echo 'selected';} ?>>No</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group mb-3">
                                                ...
                                                <textarea type="text" id="editor" class="form-control" name="description" required><?php echo $datajobpost->company_des; ?></textarea>
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
                                            <div class="form-group mb-3">
                                                <label>Responbilities</label>
                                                <textarea type="text" id="editor1" class="form-control" name="responbilities" required><?php echo $datajobpost->company_responbility_home; ?></textarea>
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
                                            <div class="form-group mb-3">
                                                <label>Requirements</label>
                                                <textarea type="text" id="editor2" class="form-control" name="requirements" required><?php echo $datajobpost->company_requirement_home; ?></textarea>
                                            </div>
                                        </div>
