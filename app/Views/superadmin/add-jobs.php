                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group mb-3">
                                                ...
                                                <select name="degree_level_id" id="degree_level_id" class="form-control select2" required>
                                                <option selected hidden>Select ...</option>
                                                <?php
                                                    foreach($degree as $s)
												    {
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group mb-3">
                                                ...
                                                <select name="degree_type_id" id="degree_type_id" class="form-control select2" required>
                                                <option selected hidden>Select ...</option>
                                                <?php
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group mb-3">
                                                <label>Company</label>
                                                <select name="companyid" id="companyid" class="form-control select2" required>
                                                <option selected hidden>Select ...</option>
                                                <?php
                                    ...
                                    <div class="row" style="margin-top: 20px;">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group mb-3">
                                                ...
                                                <select name="job_experience_id" id="job_experience_id" class="form-control select2" required>
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group mb-3">
                                                ...
                                                <select name="salary_period_id" id="salary_period_id" class="form-select" required>
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="number" name="contact_person_number" class="form-control border-dark" required>
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            <div class="form-group mb-3">
