                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            foreach($jobslistss as $d)
                                            {
                                                ...
                                                $joblist=$this->commonModel->fs('job_applicants',array('id'=>$job_id));
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                               <a href="<?php echo base_url('back/assets/images/userResume/'.$d->resume_pdf)?>" class="btn btn-sm btn-primary w-20" download >Download</a>
