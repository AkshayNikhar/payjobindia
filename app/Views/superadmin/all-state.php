...
<head>
    <title>State  | Pay Job India</title>
                ...
                <div class="row ">
                    <div class="col-8">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18">All State</h4>
                        </div>
                    </div>
                    <?php 
                    ...
                    <div class="col-4">
                        <div style="text-align: right;">
                            ...
                            <a href="<?= base_url('superadmin/add-state')?>" class="btn btn-primary waves-effect waves-light" >Add New</a>
                        </div>
                    </div>
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            foreach($state as $d)
                                            {
                                                ...
                                                $statewisecity=$this->commonModel->allCount('location_cities',array('state_id'=>$id));
                                                
                                        ?>
                                        <tr>
                                            <td><? echo $sr ?></td> 
                                            <td><?= esc($country->name) ?></td>
                                            <td><a href="state-wise-city/<?= esc($id) ?>"> <?= esc($d->name) ?> <span class="btn btn-primary"><?php echo $statewisecity ?></span></a></td>
                                            ...
                                            <td>
                                               ...
                                               <?php 
                                                if($assignRole == 0 && $assignid == 1) { 
                                                ?>
                                               <a href="edit-state/<?= esc($id) ?>" class="btn btn-sm btn-primary w-20"><i class="bx bx-pencil"></i></a>
            	...
            	<div class="modal-dialog">
            		<div class="modal-content">
            			<div class="modal-header">
            				<h5 class="modal-title" id="myModalLabel">Delete State</h5>
            				<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            			</div>
            			<div class="modal-body">
            			    <h5>Are you sure you want to Delete this State?</h5>
            				<form method="POST" action="delete-state" class="needs-validation" novalidate>
