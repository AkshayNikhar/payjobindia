		...
		<div class="row">
			<div class="col-lg-12">
				<div class="banner-content text-center">
					<h1>Employer Login</h1> <span></span>
				</div>
			</div>
		</div>
	</div>
        ...
        <div class="row justify-content-center align-items-center">
            <div class="col-md-4 col-lg-4 col-sm-6 mb-3">
                <div class="form-container">
                    ...
                    <form class="form-horizontal" method="post" action="<?php echo base_url('login-employer') ?>">
                        ...
                        <div class="form-group text-center">
                           <a class="forgot-pass" href="<?php echo base_url('employer-forgot-password') ?>"><i class="fa fa-key pr-1"></i> I Forgot Password</a>
                        </div>
                        <div class="form-group text-center">
                            <button class="btn btn-primary btn-block mt-2 text-white" name="submit" id="submit">Login</button>
                        </div>
                        <div class="form-group text-center">
                             <a href="<?php echo base_url('employer-registration') ?>" class="btn btn-block btn-warning mt-2">Create Account</a>
                        </div>
                        
                    </form>
                    <div class="form-group text-center d-none">
                        Are You <a class="forgot-pass" href="<?php echo base_url('consultant/') ?>"> Consultant</a>
                    </div>
                </div>
            ...
            <div class="col-md-5 col-lg-5 col-sm-6 mb-3">
                <img src="<?php echo base_url('front/assets/images/auth/employer-login.png') ?>" class="img-fluid">
            </div>
        </div>
    </div>
    </div>
