		...
		<div class="row">
			<div class="col-lg-12">
				<div class="banner-content text-center">
					<h1>Vendor Registration</h1> <span></span>
				</div>
			</div>
		</div>
	</div>
        ...
        <div class="row justify-content-center align-items-center">
            <div class="col-md-4 col-lg-4 col-sm-6 mb-3">
                <div class="form-container">
                    <h3 class="title text-center mb-3">Vendor Registration</h3>
                    <?php echo $this->include ('includes/displayerrors.php') ?>
                    <form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?php echo base_url('store-vendor') ?>">
                       <div class="row">
                        ...
                        <div class="form-group text-center">
                           <a class="forgot-pass" href="<?php echo base_url('vendor-login') ?>"><i class="fa fa-user-circle pr-1"></i> Already have account login?</a>
                        </div>
