<?php
$session = session();
// echo $jobSlug = $session->get('job1');

$previousUrl = previous_url();

// $previousUrls = remove_index($previousUrl);

$previousUrls = str_replace(site_url(), '', $previousUrl);

// echo $previousUrls;
// if ($previousUrl) {
//     // Previous URL is available
//     echo 'Previous URL: ' . $previousUrl;
// } else {
//     // No previous URL available
//     echo 'No previous URL stored in the session.';
// }
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="col-md-4 col-lg-4 col-sm-6 mb-3">
                <div class="form-container">
                    ...
                    <form class="form-horizontal" method="post" action="<?php echo base_url('login-candidate') ?>">
                        ...
                        <input type="hidden" name="job_url_id" value="<?php echo $previousUrls; ?>" >
