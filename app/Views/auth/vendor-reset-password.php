        ...
        <div class="row justify-content-center align-items-center">
            <div class="col-md-4 col-lg-4 col-sm-6 mb-3">
                <div class="form-container">
                    ...
                    <form class="form-horizontal" method="post" action="<?php echo base_url('password-reset-by-vendor') ?>">
                        <div class="form-group">
                            <label class="mb-2">Email</label>
                            <input type="email" class="form-control" name="email" value="<?php echo $userdata->email ?>" readonly>
                        </div>
                        ...
                        <div class="form-group text-center">
                             <a href="<?php echo base_url('vendor-registration') ?>" class="btn btn-block btn-warning mt-2 text-white">Create Account</a>
                        </div>
