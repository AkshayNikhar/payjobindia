        ...
        <div class="row justify-content-center align-items-center">
            <div class="col-md-4 col-lg-4 col-sm-6 mb-3">
                <div class="form-container">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url('forgot-password-by-vendor') ?>" method="post">
                        <div class="form-group">
                            <label class="mb-2">Enter your email address and your password will be reset and email to you.</label>
                            <input type="email" class="form-control" name="vendoremail" required>
                        </div>
                        ...
                        <div class="form-group text-center">
                             <a href="<?php echo base_url('employer-registration') ?>" class="btn btn-block btn-warning mt-2 text-white">Create Account</a>
                        </div>
