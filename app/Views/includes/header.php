...
$this->userjobcate_id=$candidatedetails->jobcate_id;
$this->usercareerlevel_id=$candidatedetails->careerlevel_id;
}
...
<div class="top-bar2">
		...
		<div class="top-bar-right">
                ...
                <div class="post-job-btn"> <a class="primry-btn-2 lg-btn" href="<?php echo base_url('vendor-login') ?>" title="Member Login"><i class="fa fa-briefcase pr-5"></i></a> </div>
                <!--<div class="post-job-btn"> <a class="primry-btn-2 lg-btn" href="<?php echo base_url('vendor-login') ?>"><i class="fa fa-briefcase pr-5"></i> Member Login</a> </div>-->
		...
		<div class="menu-area">
			...
			<div class="main-menu">
				...
				<ul class="menu-list">
					...
					<li class=""> <a href="<?php echo base_url('jobs') ?>" class="">Jobs</a> </li>
					...
					<li class="menu-item-has-children"> <a href="#" class="drop-down">For Candidate</a>
						<ul class="sub-menu">
							<li><a href="<?php echo base_url('cities') ?>">Job By City</a>
								<!--<ul class="sub-menu">-->
							...
							<li><a href="<?php echo base_url('category') ?>">Job By Category</a>
								<!--ul class="sub-menu">
					...
					<li class="menu-item-has-children d-none"> <a href="#" class="drop-down">For Employer</a>
						<ul class="sub-menu">
							<li><a href="<?php echo base_url('employer-login') ?>">Start Hiring</a></li>
                    ...
                    {
                    ?>
					<li class="menu-item-has-children"> <a href="#" class="drop-down">Login</a>
						<ul class="sub-menu">
							<li><a href="<?php echo base_url('employer-login') ?>">For Employer</a></li>
							<li><a href="<?php echo base_url('candidate-login') ?>">For Candidate</a></li>
						</ul>
					</li>
					<?php } else { } ?>
				...
				<div class="for-mobile-menu d-lg-none d-block">
					<div class="sign-in-btn mb-25">
						<a class="primry-btn-1 lg-btn" href="<?php echo base_url('candidate-login') ?>">
					...
					<div class="post-job-btn mb-30">
						<a class="primry-btn-2 lg-btn" href="<?php echo base_url('employer-login') ?>">
			...
			<ul>
				...
				<li class="d-none">
					<a href="<?php echo base_url('candidate/setting') ?>">
						<i class="fa fa-bookmark-o text-primary"></i> Setting </a>
				</li>
				<li>
					...
					<li class="d-md-flex d-none">
						...
						<div class="post-job-btn">
						    <a class="btn btn-block btn-warning" href="<?php echo base_url('employer-login') ?>"><i class="fa fa-briefcase pr-5"></i> Post Job</a> 
						</div>
					</li>
