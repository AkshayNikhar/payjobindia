		...
		<div class="row">
			<div class="col-lg-12">
				<div class="banner-content text-center">
					<h1>Job By <?php echo $careerlevel->name ?></h1> <span></span>
				</div>
			</div>
		</div>
	</div>
				...
				<div class="row mb-60">
					...
					<div class="col-lg-12 ">
						<div class="row">
						     ...
						     $jobs=$this->commonModel->allFetch('jobs_list',array('career_level_id'=>$careerlevel->id));
						     if(count($jobs)>0){
											...
											<div class="apply-btn">
											    ...
											    <?php 
        							                 ...
        							                 //   print_r($already);
                    							        ...
                    							        <!--<a href="job1/<!?= esc($list->slug) ?>" class="primry-btn-2 lg-btn">Apply </a> -->
        											    <?php
                                                         }
                                                         else
                                                         { ?>
