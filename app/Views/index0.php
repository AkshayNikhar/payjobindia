										...
										<div class="company-area">
											...
											<div class="company-details">
												<div class="name-location">
													...
													<h3><a href="job1/<?= esc($list->slug) ?>" class="text-blu"><?= esc($list->title) ?></a> - <span class="title fs-16 fw-500 text-blu"><?= esc($functionalareaidlist->name) ?> - <?= esc($degreelevelidlist->name) ?></span></h3>
											...
											<form method="post" >
											    ...
											    <button type="button" onclick="wishlistform(<?= $id ?>, <?= $canid ?>)" id="wishbtn_<?= $id ?>" class="bg-white"><i class="bi bi-bookmark"></i></button>
											</form>
											<?php } else { ?>
											...
											<div class="item-job-half">
												<div class="item-flex-box">
													<div class="item-job-pos">
														<h3 class="jb-title"><a href="" style="color:#0000ff"><?= esc($list->title) ?></a></h3>
