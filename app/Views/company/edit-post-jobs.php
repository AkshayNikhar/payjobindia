                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form method="POST" enctype="multipart/form-data" class="needs-validation" action="<?= base_url('company/edit-post-jobs'); ?>" novalidate>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text" name="contact_person_name" class="form-control border-dark" value="<?php echo $datajobpost->contact_person_name; ?>" required>
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            <div class="form-group mb-3">
                                                <label class="form-label required">Contact Person Number</label>
                                                <input type="text" name="contact_person_number" class="form-control border-dark" value="<?php echo $datajobpost->contact_person_number; ?>" required>
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            <div class="form-group mb-3">
                                                <label class="form-label required">Contact Person Designation</label>
                                                <input type="text" name="contact_person_designation" class="form-control border-dark" value="<?php echo $datajobpost->contact_person_designation; ?>" required>
                                            </div>
                                        </div>
                                        </div>
