                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form method="POST" enctype="multipart/form-data" class="needs-validation" action="<?= base_url('company/create-jobs'); ?>" novalidate>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group mb-3">
                                                ...
                                                <select name="job_category_id" id="job_category_id" class="form-select select2" required>
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group mb-3">
                                                ...
                                                <select name="functional_area_id" id="functional_area_id" class="form-control select2" required>
                                                <option selected hidden>Select ...</option>
                                                <!--?php
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group mb-3">
                                                ...
                                                <select name="career_level_id" id="career_level_id" class="form-select select2" required>
                                                    <option selected hidden>Select</option>
                                                    <!--?php
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group mb-3">
                                                ...
                                                <select name="degree_level_id" id="degree_level_id" class="form-select select2" required>
                                                <option selected hidden>Select ...</option>
                                                <?php
                                                    foreach($degree as $s)
												    {
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group mb-3">
                                                ...
                                                <select name="degree_type_id" id="degree_type_id" class="form-select select2" required>
                                                <option selected hidden>Select ...</option>
                                                <!--?php
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group mb-3">
                                                ...
                                                <select name="job_experience_id" id="job_experience_id" class="form-select select2" required>
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group mb-3">
                                                <label>Gender</label>
                                                <select name="gender_id" id="gender_id" class="form-select select2" required>
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group mb-3">
                                                ...
                                                <select name="job_shift_id" id="job_shift_id" class="form-select" required>
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group mb-3">
                                                ...
                                                <select name="salary_period_id" id="salary_period_id" class="form-select select2" required>
                                        ...
                                        <input type="hidden" name="companyid" value="<?php echo $customerid ?>"    
                                        
                                        
                                        <div class="col-lg-12">
                                            <div class="form-group mb-3">
                                                <label>Job Description</label>
                                                <textarea type="text" id="editor" class="form-control" name="company_des" ></textarea>
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
                                            <div class="form-group mb-3">
                                                <label>Responbilities</label>
                                                <textarea type="text" id="editor1" class="form-control" name="company_responbility_home" ></textarea>
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
                                            <div class="form-group mb-3">
                                                <label>Requirements</label>
                                                <textarea type="text" id="editor2" class="form-control" name="company_requirement_home" ></textarea>
                                            </div>
                                        </div>
