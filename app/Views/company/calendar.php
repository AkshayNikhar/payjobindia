...
<head>
    ...
    $(document).ready(function(){
        var calendar = $('#calendar').fullCalendar({
            ...
            events:"<?php echo base_url(); ?>/farmer/calendar/load",
            selectable:true,
            selectHelper:true,
            select:function(start, end, allDay)
            {
                ...
                if(title)
                {
                    ...
                    $.ajax({
                        url:"<?php echo base_url(); ?>/farmer/calendar/insert",
                        type:"POST",
            ...
            eventResize:function(event)
            {
                ...
                $.ajax({
                    url:"<?php echo base_url(); ?>/farmer/calendar/update",
                    type:"POST",
            ...
            eventClick:function(event)
            {
                if(confirm("Are you sure you want to remove it?"))
                {
                    var id = event.id;
                    $.ajax({
                        url:"<?php echo base_url(); ?>/farmer/calendar/delete",
                        type:"POST",
                        data:{id:id},
                        success:function()
                        {
