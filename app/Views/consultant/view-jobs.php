                ...
                <div class="row ">
                    ...
                    <div class="col-4 ">
                        <div style="text-align: right;">
                            <a href="<?php echo base_url('consultant/post-jobs') ?>" class="btn btn-primary waves-effect waves-light" >Add New</a>
                        </div>
                    </div>
                    <?php } else { } ?>
                                ...
                                <table id="datatable" class="table table-bordered mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php 
                                                if((in_array(21, $permissionIDs) && in_array($customerid, $empIDs) && in_array($assignRole, $roleIDs))) {
                                                ?>
                                               ...
                                               <?php } ?>
                                               <?php 
                                                if((in_array(22, $permissionIDs) && in_array($customerid, $empIDs) && in_array($assignRole, $roleIDs))) {
                                                ?>
                                               <a href="view-post-jobs/<?= esc($id) ?>" class="btn btn-sm btn-primary w-20">View</a>
                                               <?php } else { ?>
