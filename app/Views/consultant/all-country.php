...
<head>
    <title>Country  | Pay Job India</title>
                ...
                <div class="row ">
                    <div class="col-8">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18">All Country</h4>
                            
                        </div>
                    </div>
                    
                    
                    <!--?php if((in_array(33, $permissionIDs) && in_array($assignid, $empIDs) && in_array($assignRole, $roleIDs))) { ?-->
                    <div class="col-4">
                        <div style="text-align: right;">
                            <!--<a href="#" class="btn btn-primary waves-effect waves-light" >Add New</a>-->
                            <a href="<?= base_url('consultant/add-country')?>" class="btn btn-primary waves-effect waves-light" >Add New</a>
                        </div>
                    </div>
                    <!--?php } else{ }
                    ?-->
