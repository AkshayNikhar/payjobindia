        ...
        <div class="page-content">
            <div class="container-fluid">
                ...
                <div class="row ">
                    ...
                    <?php if((in_array(2, $permissionIDs) && in_array($customerid, $empIDs) && in_array($assignRole, $roleIDs))) { ?>
                    <div class="col-4">
                        <div style="text-align: right;">
                            <!--<a href="#" class="btn btn-primary waves-effect waves-light" >Add New</a>-->
                            <a href="<?= base_url('consultant/add-company')?>" class="btn btn-primary waves-effect waves-light" >Add New</a>
                        </div>
                    </div>
                    <?php } else{ } ?>
                </div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                               ...
                                               <?php if((in_array(3, $permissionIDs) && in_array($customerid, $empIDs) && in_array($assignRole, $roleIDs))) { ?>
                                               <a href="edit-company/<?= esc($id) ?>" class="btn btn-sm btn-primary w-20"><i class="bx bx-pencil"></i></a>
                                               <?php } else{ } ?>
                                                
                                                <?php if((in_array(4, $permissionIDs) && in_array($customerid, $empIDs) && in_array($assignRole, $roleIDs))) { ?>
                                               ...
                                               <?php if((in_array(5, $permissionIDs) && in_array($customerid, $empIDs) && in_array($assignRole, $roleIDs))) { ?>
