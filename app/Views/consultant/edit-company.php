                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form method="POST" class="needs-validation" enctype="multipart/form-data" action="<?= base_url('superadmin/edit-company'); ?>"  novalidate>
                                    ...
                                    <div class="row" style="padding-top: 20px;padding-bottom: 20px;background: #212f7c29;">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group mb-3">
                                                ...
                                                <option value="1" <?php if($datacompany->is_active==1) {echo 'selected';} ?>>Active</option>
                                                <option value="0" <?php if($datacompany->is_active==0) {echo 'selected';} ?>>Inactive</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            <div class="form-group mb-3">
                                                ...
                                                <option value="1" <?php if($datacompany->is_featured==1) {echo 'selected';} ?>>Active</option>
                                                <option value="0" <?php if($datacompany->is_featured==0) {echo 'selected';} ?>>Inactive</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row" style="margin-top: 20px;">
                                        ...
                                        <div class="col-lg-2">
                                            <div class="form-check mb-3">
                                                <input class="form-check-input" name="perdegree_level" type="checkbox" value="1" <?php if($companypermissions->degree_level=='1') {echo 'checked';} ?>>
                                                <label class="form-check-label" for="formCheck1">
                                                   View Degree Level
                                                </label>
                                            </div>
                                        ...
                                        <div class="col-lg-2">
                                            <div class="form-check mb-3">
                                                <input class="form-check-input" name="perdegree_type" type="checkbox" value="1" <?php if($companypermissions->degree_type=='1') {echo 'checked';} ?>>
                                                <label class="form-check-label" for="formCheck1">
                                                   View Degree Type
                                                </label>
                                            </div>
                                        ...
                                        <div class="col-lg-2">
                                            <div class="form-check mb-3">
                                                <input class="form-check-input" name="perfunctional_area" type="checkbox" value="1" <?php if($companypermissions->functional_area=='1') {echo 'checked';} ?>>
                                                <label class="form-check-label" for="formCheck1">
                                        ...
                                        <div class="col-lg-2">
                                            <div class="form-check mb-3">
                                                <input class="form-check-input" name="perexp" type="checkbox" value="1" <?php if($companypermissions->exp=='1') {echo 'checked';} ?>>
                                                <label class="form-check-label" for="formCheck1">
                                                    View Experience
                                                </label>
                                            </div>
                                        ...
                                        <div class="col-lg-2">
                                            <div class="form-check mb-3">
                                                <input class="form-check-input" name="perlogo" type="checkbox" value="1" <?php if($companypermissions->logo=='1') {echo 'checked';} ?>>
                                                <label class="form-check-label" for="formCheck1">
                                                    View logo
                                                </label>
                                            </div>
                                        ...
                                        <div class="col-lg-2">
                                            <div class="form-check mb-3">
                                                <input class="form-check-input" name="pertechnical_skill" type="checkbox" value="1" <?php if($companypermissions->technical_skill=='1') {echo 'checked';} ?>>
                                                <label class="form-check-label" for="formCheck1">
                                                    View Technical Skill
                                                </label>
                                            </div>
                                        </div>
