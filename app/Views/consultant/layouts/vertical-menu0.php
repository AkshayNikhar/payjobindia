            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <a href="javascript: void(0);" class="has-arrow waves-effect">
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <?php 
                        if((in_array(1, $permissionIDs) && in_array($customerid, $empIDs) && in_array($assignRole, $roleIDs))) {
                        ?> 
                ...
                ?>       
                <li>
                    <a href="<?php echo base_url('consultant/all-company') ?>" class="waves-effect"> <i class="bx bx-cube"></i> <span >All Company</span> </a>
                </li>
                <?php } else{ }?>
                
                <?php 
                if((in_array(6, $permissionIDs) && in_array($customerid, $empIDs) && in_array($assignRole, $roleIDs))) {
                ?> 
                <li>
                    <a href="<?php echo base_url('consultant/all-user') ?>" class="waves-effect"> <i class="bx bx-cube"></i> <span >All Candidate</span> </a>
                </li>
                <?php } else{ }?>
                
                <?php 
                if((in_array(19, $permissionIDs) && in_array($customerid, $empIDs) && in_array($assignRole, $roleIDs))) {
                ?> 
                <li>
                    <a href="<?php echo base_url('consultant/view-jobs') ?>" class="waves-effect"> <i class="bx bx-cube"></i> <span >All Jobs</span> </a>
                </li>
                <?php } else{ }?>
