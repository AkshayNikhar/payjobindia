                                ...
                                <table id="datatable" class="table table-bordered mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                               <a href="<?php echo base_url('vendor/edit-post-jobs/'.$id) ?>" class="btn btn-sm btn-primary w-20"><i class="bx bx-pencil"></i></a>
                                               <!--<a href="<?php echo base_url('vendor/edit-jobs/'.$id) ?>" class="btn btn-sm btn-primary w-20"><i class="bx bx-pencil"></i></a>-->
                                               <!--<a href="javascript:void()" onclick="openDeleteModal(<?= esc($id) ?>)" class="w-20 btn btn-sm btn-danger"><i class="bx bx-trash"></i></a> -->
                                               <a href="<?php echo base_url('vendor/view-post-jobs/'.$id) ?>" class="btn btn-sm btn-dark w-20"><i class="bx bx-show"></i></a>
                                               <!--<a href="<?php echo base_url('vendor/view-jobs/'.$id) ?>" class="btn btn-sm btn-dark w-20"><i class="bx bx-show"></i></a>-->
                                            </td>
                                        </tr>
                                        <?
                                        }
