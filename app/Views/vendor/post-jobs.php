                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form method="POST" enctype="multipart/form-data" class="needs-validation" action="<?= base_url('vendor/create-jobs'); ?>" novalidate>
                                        ...
                                        <div class="col-lg-4 d-none">
                                            <div class="form-group mb-3">
                                                <label class="form-label ">Salary Currency</label>
                                                 <select name="salary_currency" class="form-control border-dark" >
