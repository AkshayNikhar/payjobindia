        ...
        <div class="page-content">
            <div class="container-fluid">
                ...
                <div class="row ">
                    ...
                    <?php 
                    // $asd=in_array(2, $permissionIDs) && in_array($customerid, $empIDs) && in_array($assignRole, $roleIDs);exit;
                    if((in_array(2, $permissionIDs) && in_array($customerid, $empIDs) && in_array($assignRole, $roleIDs))) { ?>
                    <div class="col-4">
                        <div style="text-align: right;">
                            <a href="<?= base_url('vendor/add-company')?>" class="btn btn-primary waves-effect waves-light" >Add New</a>
                        </div>
                    </div>
                    <?php } else{ } ?>
                </div>
