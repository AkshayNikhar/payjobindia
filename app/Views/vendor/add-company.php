                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form method="POST" class="needs-validation" enctype="multipart/form-data" action="<?= base_url('vendor/create-company'); ?>"  novalidate>
                                    
                                    <div class="row d-none" style="padding-top: 20px;padding-bottom: 20px;background: #212f7c29;">
                                        <div class="col-lg-4">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <div class="form-group mb-3">
                                                ...
                                                <select name="industry_id" id="industry_id" class="form-select select2" required>
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group mb-3">
                                                ...
                                                <select name="ownership_type_id" id="ownership_type_id" class="form-select select2" required>
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group mb-3">
                                                ...
                                                <select name="no_of_employees" id="no_of_employees" class="form-select select2" required>
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group mb-3">
                                                ...
                                                <select name="no_of_offices" id="no_of_offices" class="form-select select2" required>
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group mb-3">
                                                ...
                                                <select name="established_in" id="established_in" class="form-select select2" required>
