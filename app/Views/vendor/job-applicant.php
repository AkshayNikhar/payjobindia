                                ...
                                <table class="table align-middle table-nowrap mb-0">
                                                <thead class="table-light">
                                                    <tr>
                                                        ...
                                                        <th class="align-middle">Company Status</th>
                                                        <th class="align-middle">Admin Status</th>
                                                ...
                                                <tbody>
                                                   ...
                                                   $sr=0;
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <button class="status btn-success"><?= esc($d->active_status) ?></button>
                                                        </td>
                                                        
                                                        <?php
                            							if($d->active_status=='appoved'){
                            							    $ststus='btn-success';
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="view-post-jobs1/<?= esc($user_id) ?>" class="btn btn-sm btn-primary w-20 ">View</a>
                                                            <?php } else {  ?>
                                                        ...
                                                        <td>
                                                            ...
                                                            <!--<a href="#" class="btn btn-sm btn-primary w-20 ">Pay Now</a>-->
                                                        </td>
                                                        <td class="d-none">
                                                            <?php if ($d->active_status == 0): ?>
                                                                <a href="<?= base_url("/company/change-status-jobss/$id/1") ?>"
                                                                    class="btn btn-sm btn-danger"> Reject </a>
                                                            <?php endif; ?>
                                                            <?php if ($d->active_status == 1): ?>
                                                                <a href="<?= base_url("/company/change-status-jobss/$id/0") ?>"
            	...
            	<div class="modal-dialog">
            		<div class="modal-content">
            			...
            			<div class="modal-body">
            				...
            				<form method="POST" action="<?= base_url('/vendor/edit-company-job-applicant'); ?>" class="needs-validation" novalidate>
