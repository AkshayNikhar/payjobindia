                            ...
                            <div class="card-body">
                                ...
                                <table class="table mb-0 table-bordered">
                                    <tbody>
                                        ...
                                        <?php 
                                        if((in_array(25, $permissionIDs) && in_array($customerid, $empIDs) && in_array($assignRole, $roleIDs))) 
                                        {
                                        ?>
                                        <tr>
                                        ...
                                        <?php 
                                        if((in_array(26, $permissionIDs) && in_array($customerid, $empIDs) && in_array($assignRole, $roleIDs))) 
                                        {
                                        ?>
                                        <tr>
                                        ...
                                        <?php 
                                        if((in_array(27, $permissionIDs) && in_array($customerid, $empIDs) && in_array($assignRole, $roleIDs))) 
                                        {
                                        ?>
                                        <tr>
                                        ...
                                        <?php 
                                        if((in_array(29, $permissionIDs) && in_array($customerid, $empIDs) && in_array($assignRole, $roleIDs))) 
                                        {
                                        ?>
                                        <tr>
