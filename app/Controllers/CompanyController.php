...
class CompanyController extends BaseController
{
    ...
    public function addjobs()
    {
        ...
        $data['functionarea']=$this->commonModel->allFetchd('function_area',array('is_active'=>1));
    ...
    public function viewpostjobs($id)
    {
        $data['datajobpost']=$this->commonModel->fs('jobs_list',array('id'=>$id));
        // print_r($data);
        return view('company/view-post-jobs',$data);
    }
    ...
    public function viewpostjobs1($id)
    {
        ...
        // print_r($data);
        return view('company/view-post-jobs1',$data);
    }
    ...
    public function editjobspost1()
    {
        ...
        if($update)
          ...
          {
            $this->session->setFlashdata('error', 'Something went wrong. Try again later.');
            return redirect()->to(base_url('company/edit-post-jobs/',$id));
          }
    ...
    public function companyjobapplicant()
    {
        ...
        return view('company/job-applicant',$data);
    }
    ...
    public function editcompanyjobaplicantss($id)
    {
        ...
        // print_r($data);exit;
        return view('company/edit-company-job-applicant',$data);
    }
    ...
    public function jobspostview($id)
    {
        ...
        // print_r($data);exit;
        return view('company/jobs-post-view',$data);
    }
    ...
    public function viewcandidatejobapplicant($id)
    {
        ...
        // print_r($data);exit;
        return view('company/view-candidate-job-applicant',$data);
    }
    ...
    public function editcompanyjobaplicant1()
    {
        ...
        //   print_r($save);exit;
          ...
          if($update)
          {
            ...
            return redirect()->to(base_url('company/job-applicant'));
          }
         else
          {
            $this->session->setFlashdata('error', 'Something went wrong. Try again later.');
    ...
    public function editcompanyjobaplicant10()
    {
        ...
        if($update)
          ...
          {
            $this->session->setFlashdata('error', 'Something went wrong. Try again later.');
            return redirect()->to(base_url('company/edit-company-job-applicant/',$id));
          }
    }
    ...
    public function viewChangePassword()
    {
        ...
        return view('company/change-password',$data);
    }
