        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="index.php" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="back/assets/images/logo.svg" alt="" height="22">
                    </span>
                    <span class="logo-lg">
                        <img src="back/assets/images/logo-dark.png" alt="" height="17">
                    </span>
                </a>

                <a href="index.php" class="logo logo-light">
                    <span class="logo-sm">
                        <img src="back/assets/images/logo-light.svg" alt="" height="22">
                    </span>
                    <span class="logo-lg">
                        <img src="back/assets/images/logo-light.png" alt="" height="19">
                    </span>
                </a>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="row">
                                ...
                                <div class="col-sm-5">
                                    <div>
                                        <img src="back/assets/images/megamenu-img.png" alt="" class="img-fluid mx-auto d-block">
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item waves-effect" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <?php if ($lang == 'en') { ?>
                        <img src="back/assets/images/flags/us.jpg" alt="Header Language" height="16">
                    <?php } ?>
                    <?php if ($lang == 'es') { ?>
                        <img src="back/assets/images/flags/spain.jpg" alt="Header Language" height="16">
                    <?php } ?>
                    <?php if ($lang == 'de') { ?>
                        <img src="back/assets/images/flags/germany.jpg" alt="Header Language" height="16">
                    <?php } ?>
                    <?php if ($lang == 'it') { ?>
                        <img src="back/assets/images/flags/italy.jpg" alt="Header Language" height="16">
                    <?php } ?>
                    <?php if ($lang == 'ru') { ?>
                        <img src="back/assets/images/flags/russia.jpg" alt="Header Language" height="16">
                    <?php } ?>
                </button>
            ...
            <div class="dropdown d-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0" aria-labelledby="page-header-notifications-dropdown">
                    ...
                    <div data-simplebar style="max-height: 230px;">
                        ...
                        <a href="" class="text-reset notification-item">
                            <div class="d-flex">
                                <img src="back/assets/images/users/avatar-3.jpg" class="me-3 rounded-circle avatar-xs" alt="user-pic">
                                <div class="flex-grow-1">
                        ...
                        <a href="" class="text-reset notification-item">
                            <div class="d-flex">
                                <img src="back/assets/images/users/avatar-4.jpg" class="me-3 rounded-circle avatar-xs" alt="user-pic">
                                <div class="flex-grow-1">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div>
                                        ...
                                        <a href="ui-placeholders.php" class="dropdown-item" key="t-Placeholders"><?php echo $language["Placeholders"]; ?></a>
                                ...
                                <div class="col-lg-4">
                                    <div>
                                        ...
                                        <a href="ui-toasts.php" class="dropdown-item" key="t-toasts"><?php echo $language["Toasts"]; ?></a>
                        ...
                        <div class="dropdown-menu" aria-labelledby="topnav-pages">
                            <div class="dropdown">
                                <a class="dropdown-item dropdown-toggle arrow-none" href="#" id="topnav-email"
                                    role="button">
                                    <span key="t-calendar"><?php echo $language["Calendars"]; ?></span> <div class="arrow-down"></div>
                                </a>
                                <div class="dropdown-menu" aria-labelledby="topnav-email">
                                    <a href="calendar.php" class="dropdown-item" key="t-tui-calendar"><?php echo $language["TUI_Calendar"]; ?></a>
                                    <a href="calendar-full.php" class="dropdown-item" key="t-full-calender"><?php echo $language["Full_Calendar"]; ?></a>
                                </div>
                            </div>
