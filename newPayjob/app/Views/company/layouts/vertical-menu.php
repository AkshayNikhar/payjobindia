        ...
        <div class="d-flex">
            <div class="dropdown d-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-end d-none">
                    <!-- item-->
                    <a class="dropdown-item" href="<?php echo base_url('farmer/dashboard') ?>"><i class="bx bx-user font-size-16 align-middle me-1"></i> <span key="t-profile">Home</span></a>
                    <a class="dropdown-item" href="<?php echo base_url('farmer/profile') ?>"><i class="bx bx-wallet font-size-16 align-middle me-1"></i> <span key="t-my-wallet">Profile</span></a>
                    <a class="dropdown-item" href="<?php echo base_url('farmer/task') ?>"><i class="bx bx-wrench font-size-16 align-middle me-1"></i> <span key="t-settings">Task</span></a>
                    <a class="dropdown-item" href="<?php echo base_url('farmer/change-password') ?>"><i class="bx bx-lock-open font-size-16 align-middle me-1"></i> <span key="t-lock-screen">Setting</span></a>
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item text-danger" href="<?= base_url('farmer/logout')?>"><i class="bx bx-power-off font-size-16 align-middle me-1 text-danger"></i> <span>Logout</span></a>
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        ...
                        <li><a href="<?php echo base_url('company/view-jobs') ?>" key="t-full-calendar">View Jobs</a></li>
                    </ul>
                </li>

                <li>
                    <a href="#" class="waves-effect"> <i class="bx bx-calendar-event"></i> <span >Jobs Applicants</span> </a>
