                                     ...
                                     <input type="hidden" name="empid" id="formrow-firstname-input" value="<?php echo $customerid ?>">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text" class="form-control" name="company_email" value="<?php echo $companydetails->company_email; ?>" required>
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            <div class="form-group mb-3">
                                                <label>Company Contact No.</label>
                                                <input type="text" class="form-control" name="phone" value="<?php echo $companydetails->phone; ?>" required>
                                            </div>
                                        </div>
