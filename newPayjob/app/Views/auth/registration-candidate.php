		...
		<div class="row">
			<div class="col-lg-12">
				<div class="banner-content text-center">
					<h1>Candidate Registration</h1> <span></span>
				</div>
			</div>
		</div>
	</div>
        ...
        <div class="row justify-content-center align-items-center">
            <div class="col-md-4 col-lg-4 col-sm-6 mb-3">
                <div class="form-container">
                    ...
                    <form class="form-horizontal" method="post" action="<?php echo base_url('store-candidate') ?>">
                       <div class="row">
                            <div class="col-lg-12">
                        ...
                        <div class="form-group text-center">
                           <a class="forgot-pass" href="<?php echo base_url('candidate-login') ?>"><i class="fa fa-user-circle pr-1"></i> Already have account login?</a>
                        </div>
            ...
            <div class="col-md-5 col-lg-5 col-sm-6 mb-3">
                <img src="<?php echo base_url('front/assets/images/auth/candidate-registration.png') ?>" class="img-fluid">
            </div>
        </div>
    </div>
</div>
