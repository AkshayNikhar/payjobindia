...
<head>
    <title>Industries  | Pay Job India</title>
                ...
                <div class="row ">
                    <div class="col-8">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18">All Industries</h4>
                            
                        </div>
                    </div>
                    <div class="col-4">
                        <div style="text-align: right;">
                            <a href="<?= base_url('superadmin/add-industry')?>" class="btn btn-primary waves-effect waves-light" >Add New</a>
                        </div>
                    </div>
                                ...
                                <table id="datatable" class="table table-bordered mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                               <a href="edit-industry/<?= esc($id) ?>" class="btn btn-sm btn-primary w-20"><i class="bx bx-pencil"></i></a>
            	...
            	<div class="modal-dialog">
            		<div class="modal-content">
            			<div class="modal-header">
            				<h5 class="modal-title" id="myModalLabel">Delete Industries</h5>
            				<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            			</div>
            			<div class="modal-body">
            			    <h5>Are you sure you want to Delete this Industries?</h5>
            				<form method="POST" action="delete-industry" class="needs-validation" novalidate>
