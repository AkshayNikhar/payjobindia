                ...
                <div class="row ">
                    <div class="col-8">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18">All Contact</h4>
                            ...
                            <div class="card-body">
                                ...
                                <table id="datatable" class="table table-bordered mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><? echo $sr ?></td> 
                                            <td><?= esc($contactlist->contact_name) ?></td>
                                            <td><?= esc($contactlist->contact_email) ?></td>
                                            <td><?= esc($contactlist->contact_phone) ?></td>
                                            <td><?php echo $contactlist->contact_crop ?> </td>
                                            <td><?php echo $contactlist->contact_description ?> </td>
                                            <td><?php echo date('d M Y',strtotime($contactlist->contact_created_at)) ?> </td>
                                        </tr>
                                        <?
                                        }
                                        ?>
