			...
			<div class="container">
				<div class="row mb-60">
					<div class="col-lg-8 ">
							...
							<div class="col-lg-6 col-md-6 d-none">
								<div class="job-listing-card2">
									<div class="job-content">
										...
										<div class="job-type-apply">
											<div class="job-type"> <span class="light-green">Full Time</span> </div>
											<div class="apply-btn"> <a href="" class="primry-btn-2 lg-btn">Apply Now</a> </div>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="job-listing-card2">
									<div class="job-content">
										<div class="company-area">
											...
											<div class="company-details">
												<div class="name-location">
													<h5><a href="">WordPress Developer</a></h5>
													<ul>
														<li>
															<p><span class="title">Post Date:</span> 2 Dec, 2023</p>
														</li>
						...
						<div class="text-center"> <a href="<?php echo base_url('jobs')?>" class="primry-btn-2 lg-btn mb-2">View All Latest Jobs</a> </div>
					</div>
					<div class="col-lg-4">
											...
											<div class="item-job-half">
												<div class="item-flex-box">
													<div class="item-job-pos">
														<h3 class="jb-title"><a href="" style="color:#0000ff">Digital Marketer</a></h3>
														<div class="job-location"> <span><i class="fa fa-map-marker pr-10 pl-5"></i>Location : Nagpur</span> <span class="ml-2"><i class="fa fa-intersex pr-10 pl-5"></i>Gender : Both</span> <span class="ml-2"><i class="fa fa-plus-square-o pr-10 pl-5"></i>Experience : 1 Year</span> <span class="ml-2"></span><i class="fa fa-inr pr-10 pl-5"></i> Salary : 5000 <span class="suffix">INR</span> - <span class="price-text">5000 <span class="suffix">INR</span></span> <span class="ml-2"><i class="fa fa-calendar-check-o pr-10 pl-5"></i> Post Date : Nov 18, 2023</span> </div>
													</div>
												</div>
											</div>
										</div>
									...
									<article>
										<div class="item-job-list bottom-hover">
											<div class="item-job-half">
												<div class="item-flex-box">
													<div class="item-job-pos">
														<h3 class="jb-title"><a href="" style="color:#0000ff">Graphic Designer</a></h3>
														<div class="job-location"> <span><i class="fa fa-map-marker pr-10 pl-5"></i>Location : Nagpur</span> <span class="ml-2"><i class="fa fa-intersex pr-10 pl-5"></i>Gender : Both</span> <span class="ml-2"><i class="fa fa-plus-square-o pr-10 pl-5"></i>Experience : 1 Year</span> <span class="ml-2"></span><i class="fa fa-inr pr-10 pl-5"></i> Salary : 5000 <span class="suffix">INR</span> - <span class="price-text">5000 <span class="suffix">INR</span></span> <span class="ml-2"><i class="fa fa-calendar-check-o pr-10 pl-5"></i> Post Date : Nov 18, 2023</span> </div>
													</div>
												</div>
											</div>
						...
						<div class="swiper trusted-company-slider">
							<div class="swiper-wrapper">
								<div class="swiper-slide">
									<div class="company-logo"><a href="<?php echo base_url('company-profile/elite-hangstroman') ?>"><img src="<?php echo base_url('front/assets/images/company/1.jpg') ?>" alt=""></a> </div>
								</div>
								<div class="swiper-slide">
									<div class="company-logo"><a href="<?php echo base_url('company-profile/elite-hangstroman') ?>"><img src="<?php echo base_url('front/assets/images/company/2.jpg') ?>" alt=""></a> </div>
								</div>
								<div class="swiper-slide">
									<div class="company-logo"><a href="<?php echo base_url('company-profile/elite-hangstroman') ?>"><img src="<?php echo base_url('front/assets/images/company/3.jpg') ?>" alt=""></a> </div>
								</div>
								<div class="swiper-slide">
									<div class="company-logo"><a href="<?php echo base_url('company-profile/elite-hangstroman') ?>"><img src="<?php echo base_url('front/assets/images/company/4.jpg') ?>" alt=""></a> </div>
								</div>
								<div class="swiper-slide">
									<div class="company-logo"><a href="<?php echo base_url('company-profile/elite-hangstroman') ?>"><img src="<?php echo base_url('front/assets/images/company/5.jpg') ?>" alt=""></a> </div>
								</div>
								<div class="swiper-slide">
					...
					<div class="col-lg-6">
						<div class="user-feedback-left">
							<div class="section-title1">
								...
								<div class="sign-in-btn"> <a class="primry-btn-2 lg-btn" href="">  Login Now <i class="fas fa-angle-right pl-5"></i></a> </div>
							</div>
						</div>
					</div>
					<div class="col-lg-6">
